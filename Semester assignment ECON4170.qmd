...
#alligning the dates, so that there is no NA values or other data that can effect our models ability to predict. 

cor(ELP$Price_NOK, ELP$lag_hour, use = "complete.obs")
cor(ELP$Price_NOK, ELP$lag_day, use = "complete.obs")
cor(ELP$Price_NOK, ELP$lag_week, use = "complete.obs")

ggplot(ELP, aes(x =hourly_time, y = Price_NOK)) +
  geom_line() +
