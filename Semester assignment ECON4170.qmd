...
# Align x_test to training design###AI###
...
Diebold_Mariano_Test <- data.frame(
  naive_1_P2 = dm_test1_P2$p.value,
  naive_1_P1 = dm_test1_P1$p.value,
  snavive_24_P2 = dm_test24_P2$p.value,
  snaive_24_P1 = dm_test24_P1$p.value,
  snaive_168_P2 = dm_test168_P2$p.value,
  snaive_168_P1 = dm_test168_P1$p.value
)
```
...
ggplot(forecastPlots, aes( x = time)) +
...
ggplot(forecastPlots, aes(x = error)) +
