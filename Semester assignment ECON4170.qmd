...
MODEL <- lm(
  y_next ~ price_lag24 + price_lag1 + price_lag168 + HDH_lag0 + HDH_lag24 +      demand_lag0 + demand_lag24 + supply_lag0 + supply_lag168 + dummy_hour +        dummy_weekday, data = final_data)
