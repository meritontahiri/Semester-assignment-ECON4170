...
MODEL <- lm(y_next ~ price_lag24 + price_lag1 + price_lag168 + HDH + HDH_lag24 + demand + demand_lag24 + Energy + supply_lag168 + dummy_hour +        dummy_weekday + dummy_week_nr + dummy_month, data = final_data)
